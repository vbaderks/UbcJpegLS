...
static void bad_flag(char *s);
static int read_header_6(FILE *fin, int *widthp, int *heightp, int *maxvalp, int *comp);
static int read_header_5(FILE *fin, int *widthp, int *heightp, int *maxvalp);
